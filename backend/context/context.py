...
def is_info_agent(infotext):
    prompt = "The user was given the following prompt: 'Enter documentation if you have any.'. The user has entered the following information: " + infotext + ". Has the user provided any information about the software? ANSWER ONLY WITH YES OR NO IN ALL CAPS."
